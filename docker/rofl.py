"""
https://raw.githubusercontent.com/oasisprotocol/template-rofl-hl-copy-trader/refs/heads/master/src/clients/rofl.py
...
def get_keypair(key_id: str = COPY_TRADE_KEY):
    """Get a keypair using the RoflAppdClient.
    
    Args:
        key_id (str, optional): A unique identifier for the key. Defaults to COPY_TRADE_KEY.
